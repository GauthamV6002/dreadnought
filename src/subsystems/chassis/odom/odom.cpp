...
namespace subsystems {
    ...
    void Chassis::updateOdometry(void* param) {
        ...
        prevHeading = currentHeading; // Headings are in degrees, the DELTAS are in radians
        ...
        float avgHeading = utils::degToRad(prevHeading) + deltaHeading / 2;
    ...
    // Static member function to serve as the odom task entry point
